...
This method depends on secret React internals which don't work in React 19. We are looking into a new solution to try to make it work in React 19.
:::
...
:::note
> In previous versions Legend State had some hacks that were unstable and broke compatibility with the React Compiler, and these deprecated options were to help with those. See [migrating](../../other/migrating) for more info. They will still work for now but will be removed in a later version.
:::
