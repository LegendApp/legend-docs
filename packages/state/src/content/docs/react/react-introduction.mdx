...
A new (and fun) pattern with Legend-State is to make renders fine-grained so that your full components don't re-render at all - focusing updates to our tiny fine-grained components.
...
function MemoExample() {
  ...
  return (
    <div>
      {/* Reactive components have reactive props and children which
          re-render themselves on changes */}
      <Reactive.div
