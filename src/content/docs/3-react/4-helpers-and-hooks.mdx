...
`usePersistedObservable` returns an observable like [useObservable](../2-react-api#useobservable) with options to automatically persist it, the same as [persistObservable](../../4-guides/1-persistence).
