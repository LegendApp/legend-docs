...
See [Fast 🔥](../3-fast-) for more details of why Legend-State is so fast.
...
[Read more](../4-why) about why you'll love Legend-State ❤️

## Example

This example shows an overview of what using Legend-State looks like. See [Getting Started](./2-getting-started) to dive into how it works.

<Intro />

## Getting Started

Continue on to [Getting Started](../2-getting-started) to get started!
