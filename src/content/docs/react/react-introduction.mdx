...
This is a high level overview for how to work with Legend-State in React. See [React API](./2-react-api) for more specific details. Legend-State supports both React and React Native, but most of the examples are in React for ease of showing live demos.
