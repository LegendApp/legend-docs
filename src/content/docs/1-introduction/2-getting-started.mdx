...
import Install from "../../../Components/Install/Install.mdx";
...
[Read more](../../2-usage/1-observable)
...
[Read more](../../2-usage/2-reactivity)
...
There are also more options such as enabling getting/setting values directly with a `$` property. See [configuring](../../2-usage/3-configuring) for more details.
...
Head over to [React Introduction](../../3-react/1-react-introduction) for a detailed guide to getting started in React.
...
[Read more](../../4-guides/1-persistence)
