...
function App() {
  ...
  transformCode={(code) =>
    code
      .replace(/className="footer"/g, 'className="bg-zinc-600 text-center text-white text-sm overflow-hidden"')
      .replace(/className="input"/g, 'className="bg-zinc-900 text-white border rounded border-zinc-600 px-2 py-1 mt-2"')
  }
/>
...
function Example() {
  ...
  renderCode=";render(<App />)"
  transformCode={(code) =>
    code.replace(/className="input"/g, 'className="bg-zinc-900 text-white border rounded border-zinc-600 px-2 py-1 mt-2 mb-6"')
  }
/>
...
function App() {
  ...
  transformCode={(code) =>
    code
      .replace(/className="input"/g, 'className="bg-zinc-900 text-white border rounded border-zinc-600 px-2 py-1"')
      .replace(/className="messages"/g, 'className="h-64 p-2 my-3 overflow-auto border border-zinc-600 rounded [&>*]:!mt-2"')
  }
/>
...
function App() {
  ...
  transformCode={(code) =>
    code
      .replace(/className="toggle"/g, 'className="border border-[#717173] rounded-full select-none cursor-pointer"')
...
function App() {
  ...
  transformCode={(code) =>
    code
      ...
      .replace(/className="pageButton"/g, 'className="px-4 py-2 my-4 font-bold rounded shadow text-2xs cursor-pointer bg-zinc-600 hover:bg-zinc-500 !mt-0"')
      .replace(/className="modal"/g, 'className="relative bg-zinc-700 rounded-xl flex flex-col p-4"')
