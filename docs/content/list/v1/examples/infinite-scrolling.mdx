...
description: Guide for implementing bidirectional infinite scrolling
---
...
If you have a chat-like interface you may want to load more messages as you scroll up, and you can use `onStartReached` for that. If you are doing that, you will very likely want to use [maintainVisibleContentPosition](../api-reference#maintainvisiblecontentposition) so that the items loading above don't shift the viewport down.
