...
<div className="w-[800px] max-w-full mx-auto rounded-lg overflow-hidden">
    <video
...
<img src="/open-source/list/flashlight.png" className="w-[800px] max-w-full mx-auto mt-8 rounded-lg overflow-hidden border border-fd-border" />
