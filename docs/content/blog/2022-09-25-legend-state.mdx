...
<div className="text-md font-bold text-gray-100" style={{ marginBottom: '-1.25rem' }}>
1. <span className="text-lg mr-2">⚡️</span> Much faster
2. <span className="text-lg mr-2">🦄</span> Much easier to use
</div>
...
<div className="text-md font-bold text-gray-100" style={{ marginBottom: '-1.25rem' }}>
1. <span className="text-lg mr-2">🐢</span> It's slow by default
2. <span className="text-lg mr-2">🤯</span> Hooks are too complex
</div>
...
`}
  noInline={true}
  renderCode=";render(<div><HooksCount /><div style={{marginTop: '20px'}} /><LegendStateCount /></div>)"
/>

<div className="text-center pb-4" style={{ marginTop: -16 }}><a href="https://codesandbox.io/s/legend-state-primitives-140tmg" target="_blank">Try in a CodeSandbox</a></div>
...
`}
  noInline={true}
  renderCode=";render(<div><HooksModal /><div style={{marginTop: '20px'}} /><LegendStateModal /></div>)"
/>

<div className="text-center pb-4" style={{ marginTop: -16 }}><a href="https://codesandbox.io/s/legend-state-modal-0ygrrf" target="_blank">Try in a CodeSandbox</a></div>
...
<div className="text-center pb-4" style={{ marginTop: -16 }}><a href="https://codesandbox.io/s/legend-state-observe-title-ph1hbb" target="_blank">Try in a CodeSandbox</a></div>
...
<div className="text-center pb-4" style={{ marginTop: -16 }}><a href="https://codesandbox.io/s/legend-state-tree-03bggb" target="_blank">Try in a CodeSandbox</a></div>
...
Even without all these fine-grained rendering improvements, Legend-State is faster than the other major React state libraries. In addition to minimizing renders, it's extremely optimized to be as [fast as possible](/dev/state/fast).
...
<div className="text-center pb-4" style={{ marginTop: -16 }}><a href="https://codesandbox.io/s/legend-state-chat-8jebe4" target="_blank">Try in a CodeSandbox</a></div>
