...
function TreeLeaf({ count, observable }: any) {
    ...
    return (
        <FlashingDiv className="p-4 bg-gray-700 border border-gray-500 rounded">
            ...
            <div className="leading-loose whitespace-nowrap">
                ...
                <b>
                    {observable ? (
                        <Memo>{() => (
                            <FlashingDiv span className="inline-block leading-normal text-center bg-gray-700">
                                {count.get()}
                            </FlashingDiv>
                        )}</Memo>
                    ) : (
...
function TreeLeft({ count, observable }: any) {
    const renderCount = ++useRef(-1).current;
    return (
        <FlashingDiv className="w-48 p-4 bg-gray-800 border border-gray-600 rounded">
...
function TreeRight() {
    const renderCount = ++useRef(-1).current;
    return (
        <FlashingDiv className="p-4 bg-gray-800 border border-gray-600 rounded">
