...
function TreeLeft({ count, observable }: any) {
    const renderCount = ++useRef(-1).current;
    return (
        <FlashingDiv className="w-48 p-4 bg-zinc-800 border border-zinc-600 rounded">
...
function TreeRight() {
    const renderCount = ++useRef(-1).current;
    return (
        <FlashingDiv className="p-4 bg-zinc-800 border border-zinc-600 rounded">
...
function BasicPrimitive() {
        ...
        return (
            <div className="text-sm" style={{ width: 240 }}>
                <FlashingDiv>
                    <div className="p-4 bg-zinc-900 border rounded-lg border-fd-border">
            ...
            <div className="text-sm" style={{ width: 240 }}>
                <div className="p-4 bg-zinc-900 border rounded-lg border-fd-border">
                    ...
                    <div>
                        Count:{' '}
                        <Memo>{() => (
                            <FlashingDiv span className="bg-zinc-900">
                                {count.get()}
                            </FlashingDiv>
                        )}</Memo>
                    </div>
