...
description: Legend-State 2.0 brings a powerful sync system plus major improvements in DX and performance.
...
We initially started Legend-State to power the state the and sync system of both [Legend](https://legendapp.com/) and [Bravely](https://www.bravely.io/). We released 1.0 when the state part was solid and stable, while we were still perfecting and beta testing the persistence plugin. And then this wonderful community grew up around it ❤️ and we've learned how to improve it for more varied usage.
...
See the [Persistence Guide](/state/v2/guides/persistence/) for more details. And please let us know on [GitHub](https://github.com/LegendApp/legend-state) if anything is confusing, needs more explanation, or doesn't work as expected.
...
See [Migrating](/state/v2/other/migrating/) for more details on migrating. And feel free to contact us on [GitHub](https://github.com/LegendApp/legend-state) or [Twitter](https://twitter.com/jmeistrich) if you have any issues.
...
Join us in [Discord](https://discord.gg/5CBaNtADNX) or [GitHub](https://github.com/LegendApp/legend-state), or [talk to me on Twitter](https://twitter.com/jmeistrich) to get involved with the Legend community.
