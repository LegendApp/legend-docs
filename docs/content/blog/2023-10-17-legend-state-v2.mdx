...
> If you're new to Legend-State you may want to start at [the introduction](/open-source/state/) first.
...
Legend-State now includes a [powerful persistence/sync](/open-source/state/guides/persistence/) system with many features required for large local-first apps:
