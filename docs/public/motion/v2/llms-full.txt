...
**High performance**: Performance is extremely important to us so we designed for maximum performance with as little overhead as possible, using 0 dependencies and minimal code. This library is tree-shakeable and comes in at a total of 3kb gzipped if you use every feature.
...
To keep the code small and performance high, we tried to design this as simply as possible.
