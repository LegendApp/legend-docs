            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <Text className="text-xl max-w-3xl mx-auto">
                        LegendList supports both traditional renderItem prop and a revolutionary children approach for
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
                        <div className="bg-white/5 border-b border-white/10 px-6 py-4">
                            <Header size="h3" className="text-xl">
                        ...
                        <div className="p-6">
                            <DynamicCodeBlock code={renderItemCode} lang="jsx" />
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
                        ...
                        <div className="p-6">
                            <DynamicCodeBlock code={lazyListCode} lang="jsx" />
