    ...
    <div className="relative">
      ...
      <div className="relative max-w-6xl mx-auto px-4 pt-32 pb-12">
        <div className="text-center">
          <Header size="h1" className="text-5xl sm:text-6xl lg:text-7xl font-extrabold bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent mb-8">
            Legend List
          </Header>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <Link href="/list/docs/v2/intro" className="no-underline">
              <Button color="bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-600/25" size="large">
                Get Started
              </Button>
            </Link>
            
            <Link href="/list/docs/v2/examples" className="no-underline">
              <Button 
