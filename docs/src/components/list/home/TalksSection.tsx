            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <Text className="text-xl max-w-3xl mx-auto">
                        Learn from the creators and community. Watch talks, listen to podcasts, and discover how teams
                        are using Legend List in production
                    </Text>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {talks.map((talk, index) => (
                        ...
                        >
                            <div className="flex">
                                {/* Thumbnail/Preview */}
                                <div className="flex-shrink-0 w-40 aspect-video bg-gradient-to-br from-blue-600/20 to-purple-600/20 flex items-center justify-center">
                                    <div className="text-center">
                                        <div className="text-4xl mb-2">{talk.thumbnail}</div>
                                        <div className="inline-flex items-center gap-1 bg-black/50 px-2 py-1 rounded-full">
                                ...
                                <div className="flex-1 p-4 min-w-0">
                                    ...
                                    <Header size="h4" className="text-base mb-2 leading-tight">
                                        {talk.title}
                                    </Header>
                                    <Text className="text-white/70 text-sm mb-3 leading-relaxed">
                                        {talk.description}
                                    </Text>
                ...
                <div className="mt-16 text-center">
                    <div className="bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-white/10 rounded-2xl p-8">
                        <Header size="h3" className="text-2xl mb-4">
                            Want to Share Your Story?
                        </Header>
                        <Text className="text-white/70 mb-6 max-w-2xl mx-auto">
                            Using Legend List in production? We would love to feature your use case, performance
                            improvements, or technical insights with the community.
                        </Text>
