      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <Text className="text-xl max-w-3xl mx-auto">
            From simple data lists to complex AI chat interfaces, Legend List handles 
            the most demanding use cases with ease
          </Text>
        </div>
          ...
          <div className="flex-1">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <Header size="h4" className="text-lg mb-2">AI Chat Interfaces</Header>
                  <Text className="text-white/70">
                    Bidirectional infinite scrolling for chat history, smooth message streaming, 
                    and intelligent memory management for long conversations
                  </Text>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <Header size="h4" className="text-lg mb-2">Social Media Feeds</Header>
                  <Text className="text-white/70">
                    Handle millions of posts with variable heights, embedded media, 
                    and real-time updates without performance degradation
                  </Text>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <Header size="h4" className="text-lg mb-2">Data Tables & Analytics</Header>
                  <Text className="text-white/70">
                    Large datasets with complex filtering, sorting, and real-time updates. 
                    Perfect for admin dashboards and analytics tools
                  </Text>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <Header size="h4" className="text-lg mb-2">E-commerce Catalogs</Header>
                  <Text className="text-white/70">
                    Product listings with images, dynamic pricing, and instant search. 
                    Smooth scrolling through thousands of products
                  </Text>
                </div>
              </div>
            </div>
        ...
        <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 text-center">
            ...
            <Header size="h4" className="text-lg mb-2">Bidirectional</Header>
            <Text className="text-sm text-white/70">Load in both directions</Text>
          </div>
          
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 text-center">
            <div className="text-3xl mb-3">🔄</div>
            <Header size="h4" className="text-lg mb-2">Real-time</Header>
            <Text className="text-sm text-white/70">Live updates & streaming</Text>
          </div>
          
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 text-center">
            <div className="text-3xl mb-3">📏</div>
            <Header size="h4" className="text-lg mb-2">Dynamic Heights</Header>
            <Text className="text-sm text-white/70">Variable item sizes</Text>
          </div>
          
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 text-center">
            <div className="text-3xl mb-3">🧠</div>
            <Header size="h4" className="text-lg mb-2">Smart Memory</Header>
