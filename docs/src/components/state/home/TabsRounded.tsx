    ...
    return (
        <motion.div
            className={classNames(
                'relative cursor-pointer select-none px-1',
                name,
        ...
        >
            <div
                className={classNames(
                    'flex items-center whitespace-pre text-sm font-medium px-3 py-2',
                    isActive ? 'text-white shadow-bold' : 'text-zinc-400 hover:text-white/80',
                )}
            >
                {text}
            </div>
...
export const TabsRounded = observer(function TabsRounded<T extends string>({
    ...
    return (
        <nav
            className={classNames(
                'relative border border-tBorder bg-tBg rounded-full overflow-hidden overflow-x-auto mt-2',
                className,
            )}
        >
            <motion.div
                ...
                className="absolute top-0 h-full bg-sky-700 !mt-0"
