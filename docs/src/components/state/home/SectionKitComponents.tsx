    ...
    return (
        <div className="mt-subsection px-4">
            ...
            <Text className="max-w-4xl">
                ...
                transformer computeds, React hooks that don&apos;t re-render, and observable tools for popular
                frameworks. The core packages are free and the more advanced ones are premium.
            </Text>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 text-sm sm:gap-4 sm:text-base pt-8">
                <List
