      ...
      <div className="lg:flex items-center gap-4 pt-4">
        ...
        >
          <div className="text-gray-400 text-center">
            <p className="mb-4">Video preview would appear here</p>
            <div className="w-20 h-20 bg-white bg-opacity-80 rounded-full flex items-center justify-center mx-auto">
              <svg
          ...
          >
            ...
            >
              <div className="p-8 text-center text-gray-400">
                <p>Full video player would appear here</p>
              </div>
            </motion.div>
          </motion.div>
        )}
